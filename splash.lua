...
function stackpot.register_stacksplash(name, descr, color, def)
	local id = "mcl_stackpotions:"..name.."_splash"
    stackpot.make_convert("mcl_potions:"..name.."_splash", id)
...
stackpot.register_splash = stackpot.register_stacksplash
