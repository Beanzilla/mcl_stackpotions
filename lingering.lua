...
function stackpot.register_stacklingering(name, descr, color, def)

	local id = "mcl_stackpotions:"..name.."_lingering"
    stackpot.make_convert("mcl_potions:"..name.."_lingering", id)
...
stackpot.register_lingering = stackpot.register_stacklingering
